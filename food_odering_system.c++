#include<iostream> //basic input output hederfile
#include<string> // To enable the use of string in the program
#include<Windows.h>//To enable colors in the program
using namespace std;
// Declaring of global variables
string un; // this variable used for store user name
string pwd; //this variable used for store user password 
			// struct variables
struct bill // globale data structure for bill
{
	string bildto, dcrp1, dcrp2, dcrp3, sig, bid, d, y, m;
	double price, price2, price3, quantity, quantity1, quantity2, to, tax, nt;
};
struct food //globale data structure for food
{
	string fdname;
	string fid;
	double price;
...
food foodarray[23]; //decleration of array for food details
food addfood[1]; //decleration of array for add food details
...
void flist()// this function used to store all food arrys
{
...
void mainmenu()// the main log in screen
{
	system("cls");
	system("color 2");
...
void userlogin() // user log in
{
	...
	cout << "\t\tPlease enter your user password: ";
	cin >> pwd;
	if ((un == "USER") && (pwd == "U1234"))//User name and password authentication
	{
...
void acntlogin()// Accountant log in
{
	...
	cout << "\t\tPlease enter your user password: ";
	cin >> pwd;
	if ((un == "Accountant") && (pwd == "AC1234"))//Accountant name and password authentication
	{
		system("cls");
